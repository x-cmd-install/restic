...
[![x-cmd/install — restic Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/restic.svg?lang=zh)](https://x-cmd.com/install/restic)
...
合计: **79,929** 行代码（覆盖前 5 种语言、共 **588** 个文件）。
...
- **上游仓库**: <https://github.com/restic/restic>
- **官网**: <https://restic.net>
- **许可证**: BSD-2-Clause
...
- **Star**: 36,195 · **Fork**: 1,882 · **开放 issue**: 3,025 · **贡献者**: 434

## 累计统计

- **发布数**: 51 · **已合并 PR**: 2461 · **开放 PR**: 122 · **已关闭 issue**: 2555 · **开放 issue**: 470 · **提交数**: 9906
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/restic.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:10:57Z._
